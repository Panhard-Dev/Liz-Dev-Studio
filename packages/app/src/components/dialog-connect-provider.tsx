import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@liz-ai-brasil/sdk/v2/client"
...
import { Icon } from "@liz-ai-brasil/ui/icon"
import { IconButton } from "@liz-ai-brasil/ui/icon-button"
import { List, type ListRef } from "@liz-ai-brasil/ui/list"
import { ProviderIcon } from "@liz-ai-brasil/ui/provider-icon"
import { Spinner } from "@liz-ai-brasil/ui/spinner"
import { TextField } from "@liz-ai-brasil/ui/text-field"
import { showToast } from "@liz-ai-brasil/ui/toast"
  ...
  function ApiAuthView() {
    ...
    return (
      <div class="flex flex-col gap-6">
        <Switch>
          <Match when={provider().id === "liz"}>
            <div class="flex flex-col gap-4">
              <div class="text-14-regular text-text-base">{language.t("provider.connect.lizZen.line1")}</div>
              <div class="text-14-regular text-text-base">{language.t("provider.connect.lizZen.line2")}</div>
              <div class="text-14-regular text-text-base">
                {language.t("provider.connect.lizZen.visit.prefix")}
                <Link href="https://liz.ai/zen" tabIndex={-1}>
                  {language.t("provider.connect.lizZen.visit.link")}
                </Link>
                {language.t("provider.connect.lizZen.visit.suffix")}
              </div>
            </div>
          </Match>
          <Match when={true}>
