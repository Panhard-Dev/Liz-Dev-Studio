import { AppIcon } from "@liz-ai-brasil/ui/app-icon"
...
import { Keybind } from "@liz-ai-brasil/ui/keybind"
...
export function SessionHeader() {
  ...
  const isDesktopBeta = platform.platform === "desktop" && import.meta.env.VITE_LIZ_CHANNEL === "beta"
  ...
  onMount(() => {
    setCenterMount(document.getElementById("liz-titlebar-center"))
    setRightMount(document.getElementById("liz-titlebar-right"))
  })
