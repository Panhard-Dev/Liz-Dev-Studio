...
beforeAll(async () => {
  ...
  mock.module("@liz-ai-brasil/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@liz-ai-brasil/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@liz-ai-brasil/ui/icon", () => ({ Icon: () => null }))
  mock.module("@liz-ai-brasil/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
