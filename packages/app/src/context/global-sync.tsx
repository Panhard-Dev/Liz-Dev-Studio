...
export const loadMcpQuery = (directory: string, sdk?: LizClient) =>
  queryOptions({
    queryKey: [directory, "mcp"],
    queryFn: sdk ? () => sdk.mcp.status().then((r) => r.data ?? {}) : skipToken,
  })

export const loadLspQuery = (directory: string, sdk?: LizClient) =>
  queryOptions({
...
function createGlobalSync() {
  ...
  const sdkCache = new Map<string, LizClient>()
