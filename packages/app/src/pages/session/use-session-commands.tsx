...
import { previewSelectedLines } from "@liz-ai-brasil/ui/pierre/selection-bridge"
...
import { UserMessage } from "@liz-ai-brasil/sdk/v2"
...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const lizCommand = withCategory("LIZ AI BRASIL")
  ...
  const lizCmds = () => [
    lizCommand({
      ...
      description: "Conecte a LIZ AI BRASIL ou outros provedores.",
      slash: "connect",
      onSelect: connectProvider,
    }),
    lizCommand({
      id: "liz.login",
      title: "Entrar na LIZ AI BRASIL",
      description: "Abra o login oficial da LIZ AI BRASIL.",
      slash: "login",
      onSelect: connectLiz,
    }),
    lizCommand({
      ...
      description: "Veja seu plano, tokens, gasto em R$ e limites da LIZ.",
      slash: "usage",
      onSelect: showUsage,
    }),
  ]
