export const dict = {
  ...
  "dialog.provider.liz.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.liz.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.lizGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w LIZ AI BRASIL.",
  ...
  "provider.connect.lizZen.line1":
    "LIZ AI BRASIL Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  "provider.connect.lizZen.line2":
    "Z jednym kluczem API uzyskasz dostęp do modeli takich jak Claude, GPT, Gemini, GLM i więcej.",
  "provider.connect.lizZen.visit.prefix": "Odwiedź ",
  "provider.connect.lizZen.visit.link": "liz.ai/zen",
  "provider.connect.lizZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w LIZ AI BRASIL.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w liz.json",
  ...
  "dialog.server.description": "Przełącz serwer LIZ AI BRASIL, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja LIZ AI BRASIL ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu LIZ AI BRASIL",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (liz.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, LIZ AI BRASIL does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the LIZ AI BRASIL server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla LIZ AI BRASIL",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd LIZ AI BRASIL na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy LIZ AI BRASIL ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw LIZ AI BRASIL.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania LIZ AI BRASIL",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji LIZ AI BRASIL.",
