export const dict = {
  ...
  "dialog.provider.liz.tagline": "Modelos otimizados e confiáveis",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no LIZ AI BRASIL.",
  ...
  "prompt.usageLimits.label": "Limites de uso restantes",
  ...
  "toast.update.description": "Uma nova versão do LIZ AI BRASIL ({{version}}) está disponível para instalação.",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (liz.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: LIZ AI BRASIL ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do LIZ AI BRASIL",
  ...
  "settings.general.row.theme.description": "Personalize como o LIZ AI BRASIL é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o LIZ AI BRASIL iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do LIZ AI BRASIL.",
