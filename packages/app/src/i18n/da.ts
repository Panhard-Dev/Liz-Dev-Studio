export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i LIZ AI BRASIL.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i liz.json",
  ...
  "dialog.server.description": "Skift hvilken LIZ AI BRASIL-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af LIZ AI BRASIL ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til LIZ AI BRASIL-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (liz.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, LIZ AI BRASIL understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør LIZ AI BRASIL-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for LIZ AI BRASIL",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan LIZ AI BRASIL ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om LIZ AI BRASIL følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan LIZ AI BRASIL er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når LIZ AI BRASIL starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af LIZ AI BRASIL.",
