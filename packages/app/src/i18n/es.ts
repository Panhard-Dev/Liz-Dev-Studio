export const dict = {
  ...
  "dialog.provider.liz.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.liz.tagline": "Modelos optimizados y fiables",
  "dialog.provider.lizGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en LIZ AI BRASIL.",
  ...
  "provider.connect.lizZen.line1":
    "LIZ AI BRASIL Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.lizZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.lizZen.visit.prefix": "Visita ",
  "provider.connect.lizZen.visit.link": "liz.ai/zen",
  "provider.connect.lizZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en LIZ AI BRASIL.",
  ...
  "dialog.plugins.empty": "Plugins configurados en liz.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de LIZ AI BRASIL se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de LIZ AI BRASIL ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de LIZ AI BRASIL",
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor LIZ AI BRASIL dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para LIZ AI BRASIL",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve LIZ AI BRASIL en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si LIZ AI BRASIL sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de LIZ AI BRASIL.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia LIZ AI BRASIL",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de LIZ AI BRASIL.",
