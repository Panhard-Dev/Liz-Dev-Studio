export const dict = {
  ...
  "dialog.provider.liz.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.liz.tagline": "Reliable optimized models",
  "dialog.provider.lizGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in LIZ AI BRASIL.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.lizZen.line1":
    "LIZ AI BRASIL Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.lizZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.lizZen.visit.prefix": "Visit ",
  "provider.connect.lizZen.visit.link": "liz.ai/zen",
  "provider.connect.lizZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in LIZ AI BRASIL.",
  ...
  "prompt.usageLimits.label": "Remaining usage limits",
  ...
  "dialog.plugins.empty": "Plugins configured in liz.json",
  ...
  "dialog.server.description": "Switch which LIZ AI BRASIL server this app connects to.",
  ...
  "toast.update.description": "A new version of LIZ AI BRASIL ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the LIZ AI BRASIL team",
  ...
  "error.chain.checkConfig": "Check your config (liz.json) provider/model names",
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for LIZ AI BRASIL",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when LIZ AI BRASIL launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of LIZ AI BRASIL.",
