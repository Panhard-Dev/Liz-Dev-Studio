export const dict = {
  ...
  "dialog.provider.liz.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.liz.tagline": "Modèles optimisés et fiables",
  "dialog.provider.lizGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans LIZ AI BRASIL.",
  ...
  "provider.connect.lizZen.line1":
    "LIZ AI BRASIL Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.lizZen.visit.prefix": "Visitez ",
  "provider.connect.lizZen.visit.link": "liz.ai/zen",
  "provider.connect.lizZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans LIZ AI BRASIL.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans liz.json",
  ...
  "dialog.server.description": "Changez le serveur LIZ AI BRASIL auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'LIZ AI BRASIL ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe LIZ AI BRASIL",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (liz.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'LIZ AI BRASIL ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "LIZ AI BRASIL inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "app.name.desktop": "LIZ AI BRASIL Desktop",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur LIZ AI BRASIL dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour LIZ AI BRASIL",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'LIZ AI BRASIL sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si LIZ AI BRASIL suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'LIZ AI BRASIL.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'LIZ AI BRASIL",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'LIZ AI BRASIL.",
