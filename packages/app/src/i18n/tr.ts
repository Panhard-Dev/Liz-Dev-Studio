...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "LIZ AI BRASIL tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve LIZ AI BRASIL'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve LIZ AI BRASIL'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak LIZ AI BRASIL'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler liz.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi LIZ AI BRASIL sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "LIZ AI BRASIL'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı LIZ AI BRASIL ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (liz.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: LIZ AI BRASIL henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "LIZ AI BRASIL Masaüstü",
  ...
  "settings.desktop.wsl.description": "LIZ AI BRASIL sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "LIZ AI BRASIL'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "LIZ AI BRASIL'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "LIZ AI BRASIL'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "LIZ AI BRASIL'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "LIZ AI BRASIL başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "LIZ AI BRASIL'un en son sürümünü kullanıyorsunuz.",
