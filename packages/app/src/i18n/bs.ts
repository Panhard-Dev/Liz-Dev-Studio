export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u LIZ AI BRASIL-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u LIZ AI BRASIL-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u LIZ AI BRASIL-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u liz.json",
  ...
  "dialog.server.description": "Promijeni na koji se LIZ AI BRASIL server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija LIZ AI BRASIL-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku LIZ AI BRASIL timu",
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni LIZ AI BRASIL server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u LIZ AI BRASIL-u",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se LIZ AI BRASIL pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju LIZ AI BRASIL-a.",
