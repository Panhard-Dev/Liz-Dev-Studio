...
export const dict = {
  ...
  "dialog.provider.liz.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.liz.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.lizGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av LIZ AI BRASIL",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i LIZ AI BRASIL.",
  ...
  "provider.connect.lizZen.line1":
    "LIZ AI BRASIL Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.lizZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.lizZen.visit.prefix": "Besøk ",
  "provider.connect.lizZen.visit.link": "liz.ai/zen",
  "provider.connect.lizZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i LIZ AI BRASIL.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i LIZ AI BRASIL.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i liz.json",
  ...
  "dialog.server.description": "Bytt hvilken LIZ AI BRASIL-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av LIZ AI BRASIL ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til LIZ AI BRASIL-teamet",
  ...
  "sidebar.gettingStarted.line1": "LIZ AI BRASIL inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør LIZ AI BRASIL-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for LIZ AI BRASIL",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan LIZ AI BRASIL ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om LIZ AI BRASIL skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan LIZ AI BRASIL er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når LIZ AI BRASIL starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av LIZ AI BRASIL.",
