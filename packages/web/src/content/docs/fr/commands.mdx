...
Vous pouvez ajouter des commandes personnalisées via la configuration LIZ AI BRASIL ou en créant des fichiers markdown dans le répertoire `commands/`.

---

### JSON

Utilisez l'option `command` dans votre LIZ AI BRASIL [config](/docs/config) :
...
liz comprend plusieurs commandes intégrées comme `/init`, `/undo`, `/redo`, `/share`, `/help` ; [en savoir plus](/docs/tui#commands).
