---
title: TUI
description: Utilisation de l’interface utilisateur du terminal LIZ AI BRASIL.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL fournit une interface de terminal interactif ou TUI pour travailler sur vos projets avec un LLM.

L’exécution de LIZ AI BRASIL démarre le TUI pour le répertoire actuel.
...
Lorsque vous utilisez le LIZ AI BRASIL TUI, vous pouvez taper `/` suivi d'un nom de commande pour exécuter rapidement des actions. Par exemple:
...
Ajoutez un fournisseur à LIZ AI BRASIL. Vous permet de sélectionner parmi les fournisseurs disponibles et d’ajouter leurs clés API.
...
Quittez LIZ AI BRASIL. *Alias* : `/quit`, `/q`
...
Ceci est séparé de `liz.json`, qui configure le comportement du serveur/d'exécution.
...
Utilisez `LIZ_TUI_CONFIG` pour charger un chemin de configuration TUI personnalisé.
