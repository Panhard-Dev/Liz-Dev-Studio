---
title: Zen
description: Liste organisée de modèles fournis par LIZ AI BRASIL.
---
...
LIZ AI BRASIL Zen est une liste de modèles testés et vérifiés fournie par l'équipe LIZ AI BRASIL.

:::note
LIZ AI BRASIL Zen est actuellement en version bêta.
:::

Zen fonctionne comme n'importe quel autre fournisseur dans LIZ AI BRASIL. Vous vous connectez à LIZ AI BRASIL Zen et obtenez votre clé API. C'est **entièrement facultatif** et vous n'avez pas besoin de l'utiliser pour utiliser LIZ AI BRASIL.
...
:::tip
Nous avons testé un groupe sélectionné de modèles et de fournisseurs qui fonctionnent bien avec LIZ AI BRASIL.
:::
...
LIZ AI BRASIL Zen est une passerelle AI qui vous donne accès à ces modèles.

---

## Comment ça marche

LIZ AI BRASIL Zen fonctionne comme n'importe quel autre fournisseur dans LIZ AI BRASIL.

1. Vous vous connectez à **<a href={console}>LIZ AI BRASIL Zen</a>**, ajoutez vos informations de facturation et copiez votre clé API.
2. Vous exécutez la commande `/connect` dans le TUI, sélectionnez LIZ AI BRASIL Zen et collez votre clé API.
...
| --------------------- | --------------------- | -------------------------------------------------- | --------------------------- |
| GPT 5.5               | gpt-5.5               | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.5 Pro           | gpt-5.5-pro           | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4               | gpt-5.4               | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Pro           | gpt-5.4-pro           | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Mini          | gpt-5.4-mini          | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.4 Nano          | gpt-5.4-nano          | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex         | gpt-5.3-codex         | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.3 Codex Spark   | gpt-5.3-codex-spark   | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2               | gpt-5.2               | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.2 Codex         | gpt-5.2-codex         | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1               | gpt-5.1               | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex         | gpt-5.1-codex         | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Max     | gpt-5.1-codex-max     | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5.1 Codex Mini    | gpt-5.1-codex-mini    | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5                 | gpt-5                 | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Codex           | gpt-5-codex           | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| GPT 5 Nano            | gpt-5-nano            | `https://liz.ai/zen/v1/responses`             | `@ai-sdk/openai`            |
| Claude Opus 4.7       | claude-opus-4-7       | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.6       | claude-opus-4-6       | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.5       | claude-opus-4-5       | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Opus 4.1       | claude-opus-4-1       | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.6     | claude-sonnet-4-6     | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4.5     | claude-sonnet-4-5     | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Sonnet 4       | claude-sonnet-4       | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 4.5      | claude-haiku-4-5      | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Claude Haiku 3.5      | claude-3-5-haiku      | `https://liz.ai/zen/v1/messages`              | `@ai-sdk/anthropic`         |
| Gemini 3.1 Pro        | gemini-3.1-pro        | `https://liz.ai/zen/v1/models/gemini-3.1-pro` | `@ai-sdk/google`            |
| Gemini 3 Flash        | gemini-3-flash        | `https://liz.ai/zen/v1/models/gemini-3-flash` | `@ai-sdk/google`            |
| Qwen3.6 Plus          | qwen3.6-plus          | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Qwen3.5 Plus          | qwen3.5-plus          | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5          | minimax-m2.5          | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.5 Free     | minimax-m2.5-free     | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| MiniMax M2.7          | minimax-m2.7          | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5.1               | glm-5.1               | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| GLM 5                 | glm-5                 | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.5             | kimi-k2.5             | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Kimi K2.6             | kimi-k2.6             | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| LIZ Pixel            | liz-pixel            | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Ling 2.6 Flash        | ling-2.6-flash        | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Hy3 Preview Free      | hy3-preview-free      | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |
| Nemotron 3 Super Free | nemotron-3-super-free | `https://liz.ai/zen/v1/chat/completions`      | `@ai-sdk/openai-compatible` |

Le [model id](/docs/config/#models) dans votre configuration LIZ AI BRASIL utilise le format `liz/<model-id>`. Par exemple, pour GPT 5.5, vous utiliseriez `liz/gpt-5.5` dans votre configuration.
...
- MiniMax M2.5 Free est disponible sur LIZ AI BRASIL pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Ling 2.6 Flash Free est disponible sur LIZ AI BRASIL pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Hy3 Preview Free est disponible sur LIZ AI BRASIL pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- Nemotron 3 Super Free est disponible sur LIZ AI BRASIL pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
- LIZ Pixel est un modèle stealth gratuit sur LIZ AI BRASIL pour une durée limitée. L'équipe utilise cette période pour recueillir des retours et améliorer le modèle.
...
- LIZ Pixel : Pendant sa période gratuite, les données collectées peuvent être utilisées pour améliorer le modèle.
...
Nous avons créé LIZ AI BRASIL Zen pour :
...
4. N'avoir **aucun lock-in** en vous permettant de l'utiliser avec n'importe quel autre agent de codage. Et toujours vous permettre d'utiliser n'importe quel autre fournisseur avec LIZ AI BRASIL également.
