---
title: TUI
description: استخدام واجهة المستخدم TUI في LIZ AI BRASIL.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر LIZ AI BRASIL واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل LIZ AI BRASIL إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة LIZ AI BRASIL في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى LIZ AI BRASIL. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من LIZ AI BRASIL. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات LIZ AI BRASIL.
...
استخدم `LIZ_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
