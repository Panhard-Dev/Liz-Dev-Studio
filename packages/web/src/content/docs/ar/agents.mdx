...
يوجد نوعان من الوكلاء في LIZ AI BRASIL: وكلاء أساسيون ووكلاء فرعيون.
...
يأتي LIZ AI BRASIL مع وكيلين أساسيين مدمجين: **Build** و **Plan**. سنلقي نظرة عليهما أدناه.
...
يأتي LIZ AI BRASIL مع وكيلين فرعيين مدمجين: **General** و **Explore**. سنلقي نظرة على ذلك أدناه.

---

## المدمجة

يأتي LIZ AI BRASIL مع وكيلين أساسيين مدمجين ووكيلين فرعيين مدمجين.
...
هيّئ الوكلاء في ملف إعدادات `liz.json`:
...
- عام: `~/.config/liz/agents/`
- لكل مشروع: `.liz/agents/`
...
إذا لم يتم تحديد temperature، يستخدم LIZ AI BRASIL القيم الافتراضية الخاصة بالنموذج؛ عادة 0 لمعظم النماذج و 0.55 لنماذج Qwen.
...
هذا المسار نسبي لمكان وجود ملف الإعدادات. لذلك يعمل هذا لكل من إعدادات LIZ AI BRASIL العامة وإعدادات المشروع.
...
يستخدم معرّف النموذج في إعدادات LIZ AI BRASIL الصيغة `provider/model-id`. على سبيل المثال، إذا كنت تستخدم [LIZ AI BRASIL Zen](/docs/zen)، فستستخدم `liz/gpt-5.1-codex` لـ GPT 5.1 Codex.
...
:::tip
شغّل `liz models` لعرض قائمة بالنماذج المتاحة.
:::
...
:::tip
هل لديك وكيل تود مشاركته؟ [قدّم PR](https://github.com/anomalyco/liz).
:::
