...
LIZ AI BRASIL Go هو اشتراك منخفض التكلفة — **$5 للشهر الأول**، ثم **$10/شهريًا** — يمنحك وصولًا موثوقًا إلى نماذج البرمجة المفتوحة الشائعة.

:::note
LIZ AI BRASIL Go حاليًا في المرحلة التجريبية.
:::

يعمل Go مثل أي مزود آخر في LIZ AI BRASIL. تشترك في LIZ AI BRASIL Go وتحصل على مفتاح API الخاص بك. وهو **اختياري تمامًا**، ولا تحتاج إلى استخدامه لاستخدام LIZ AI BRASIL.
...
:::tip
اختبرنا مجموعة مختارة من النماذج والمزودين الذين يعملون جيدًا مع LIZ AI BRASIL.
:::
...
يمنحك LIZ AI BRASIL Go الوصول إلى هذه النماذج مقابل **$5 للشهر الأول**، ثم **$10/شهريًا**.

---

## كيف يعمل

يعمل LIZ AI BRASIL Go مثل أي مزود آخر في LIZ AI BRASIL.

1. تسجّل الدخول إلى **<a href={console}>LIZ AI BRASIL Zen</a>**، وتشترك في Go، ثم تنسخ مفتاح API الخاص بك.
2. تشغّل الأمر `/connect` في TUI، وتختار `LIZ AI BRASIL Go`، ثم تلصق مفتاح API الخاص بك.
3. شغّل `/models` في TUI لرؤية قائمة النماذج المتاحة عبر Go.

:::note
يمكن لعضو واحد فقط في كل workspace الاشتراك في LIZ AI BRASIL Go.
:::
...
يتضمن LIZ AI BRASIL Go الحدود التالية:
...
يستخدم [model id](/docs/config/#models) في إعدادات LIZ AI BRASIL لديك التنسيق `liz-go/<model-id>`. على سبيل المثال، بالنسبة إلى Kimi K2.6، ستستخدم `liz-go/kimi-k2.6` في إعداداتك.
...
أنشأنا LIZ AI BRASIL Go من أجل:
...
4. **عدم فرض قيود ارتباط** من خلال السماح لك أيضًا باستخدام أي مزود آخر مع LIZ AI BRASIL.
