...
LIZ AI BRASIL has a list of keybinds that you can customize through `tui.json`.
...
LIZ AI BRASIL uses a `leader` key for most keybinds. This avoids conflicts in your terminal.
...
The LIZ AI BRASIL desktop app prompt input supports common Readline/Emacs-style shortcuts for editing text. These are built-in and currently not configurable via `liz.json`.
