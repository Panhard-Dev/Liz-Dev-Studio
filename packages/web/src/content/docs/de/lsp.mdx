---
title: LSP Server
description: LIZ AI BRASIL lässt sich in Ihren LSP-Server integrieren.
---

LIZ AI BRASIL lässt sich in Ihr Language Server Protocol (LSP) integrieren, um die Interaktion von LLM mit Ihrer Codebasis zu unterstützen. Es verwendet Diagnosefunktionen, um dem LLM Feedback zu geben.

---

## Integriert

LIZ AI BRASIL verfügt über mehrere integrierte LSP-Server für gängige Sprachen:
...
:::note
Sie können LSP-Server-Downloads automatisch deaktivieren, indem Sie die Umgebungsvariable `LIZ_DISABLE_LSP_DOWNLOAD` auf `true` setzen.
:::
...
Wenn LIZ AI BRASIL eine Datei öffnet, geschieht Folgendes:
...
Sie können LSP-Server über den Abschnitt `lsp` in Ihrer LIZ AI BRASIL-Konfiguration anpassen.
