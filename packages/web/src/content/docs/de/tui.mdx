---
title: TUI
description: Arbeite mit LIZ AI BRASIL in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet LIZ AI BRASIL die TUI im aktuellen Verzeichnis.
...
In der LIZ AI BRASIL-TUI kannst du `/` plus Befehlsnamen eingeben, um Aktionen schnell auszufuehren.
Zum Beispiel:
...
Fuegt einen Provider zu LIZ AI BRASIL hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet LIZ AI BRASIL. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `liz.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `LIZ_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
