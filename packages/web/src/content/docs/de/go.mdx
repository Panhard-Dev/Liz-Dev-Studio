...
LIZ AI BRASIL Go ist ein kostengünstiges Abonnement — **5 $ für deinen ersten Monat**, danach **10 $/Monat** —, das dir zuverlässigen Zugriff auf beliebte offene Coding-Modelle bietet.

:::note
LIZ AI BRASIL Go befindet sich derzeit in der Beta-Phase.
:::

Go funktioniert wie jeder andere Provider in LIZ AI BRASIL. Du abonnierst LIZ AI BRASIL Go und
erhältst deinen API-Key. Es ist **völlig optional** und du musst es nicht nutzen, um
LIZ AI BRASIL zu verwenden.
...
LIZ AI BRASIL Go bietet dir Zugriff auf diese Modelle für **5 $ im ersten Monat**, danach **10 $/Monat**.

---

## Wie es funktioniert

LIZ AI BRASIL Go funktioniert wie jeder andere Provider in LIZ AI BRASIL.

1. Du meldest dich bei **<a href={console}>LIZ AI BRASIL Zen</a>** an, abonnierst Go und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst `LIZ AI BRASIL Go` und fügst deinen API-Key ein.
3. Führe `/models` in der TUI aus, um die Liste der über Go verfügbaren Modelle zu sehen.

:::note
Nur ein Mitglied pro Workspace kann LIZ AI BRASIL Go abonnieren.
:::
...
LIZ AI BRASIL Go beinhaltet die folgenden Limits:
...
Die [Modell-ID](/docs/config/#models) in deiner LIZ AI BRASIL Config verwendet das Format `liz-go/<model-id>`. Für Kimi K2.6 würdest du beispielsweise `liz-go/kimi-k2.6` in deiner Config verwenden.
...
Wir haben LIZ AI BRASIL Go entwickelt, um:
...
4. **Keinen Lock-in-Effekt** zu haben, indem wir dir ermöglichen, auch jeden anderen Provider mit LIZ AI BRASIL zu nutzen.
