...
Erstellen Sie `.liz/commands/test.md`:

```md title=".liz/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die LIZ AI BRASIL-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem LIZ AI BRASIL [config](/docs/config):

```json title="liz.jsonc" {4-12}
{
...
- Global: `~/.config/liz/commands/`
- Pro Projekt: `.liz/commands/`

```markdown title="~/.config/liz/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".liz/commands/component.md"
---
...
```md title=".liz/commands/create-file.md"
---
...
```md title=".liz/commands/analyze-coverage.md"
---
...
```md title=".liz/commands/review-changes.md"
---
...
```md title=".liz/commands/review-component.md"
---
...
LIZ AI BRASIL enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
