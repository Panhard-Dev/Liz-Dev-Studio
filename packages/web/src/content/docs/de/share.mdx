---
title: Teilen
description: Teile LIZ AI BRASIL-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu LIZ AI BRASIL-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht LIZ AI BRASIL Folgendes:
...
LIZ AI BRASIL hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt LIZ AI BRASIL den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`liz.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du liz in deiner Organisation einsetzt.
