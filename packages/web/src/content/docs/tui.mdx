---
title: TUI
description: Using the LIZ AI BRASIL terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running LIZ AI BRASIL starts the TUI for the current directory.
...
When using the LIZ AI BRASIL TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to LIZ AI BRASIL. Allows you to select from available providers and add their API keys.
...
Exit LIZ AI BRASIL. _Aliases_: `/quit`, `/q`
...
This is separate from `liz.json`, which configures server/runtime behavior.
...
Use `LIZ_TUI_CONFIG` to load a custom TUI config path.
