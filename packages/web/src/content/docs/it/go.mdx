...
LIZ AI BRASIL Go è un abbonamento a basso costo — **5 $ per il primo mese**, poi **10 $/mese** — che ti offre un accesso affidabile ai popolari modelli di programmazione aperti.

:::note
LIZ AI BRASIL Go è attualmente in beta.
:::

Go funziona come qualsiasi altro provider in LIZ AI BRASIL. Ti abboni a LIZ AI BRASIL Go e
ottieni la tua chiave API. È **completamente facoltativo** e non hai bisogno di usarlo per
utilizzare LIZ AI BRASIL.
...
LIZ AI BRASIL Go ti dà accesso a questi modelli a **5 $ per il primo mese**, poi a **10 $/mese**.

---

## Come funziona

LIZ AI BRASIL Go funziona come qualsiasi altro provider in LIZ AI BRASIL.

1. Accedi a **<a href={console}>LIZ AI BRASIL Zen</a>**, ti abboni a Go e
   copi la tua chiave API.
2. Esegui il comando `/connect` nella TUI, selezioni `LIZ AI BRASIL Go` e incolli
   la tua chiave API.
3. Esegui `/models` nella TUI per vedere l'elenco dei modelli disponibili tramite Go.

:::note
Solo un membro per workspace può abbonarsi a LIZ AI BRASIL Go.
:::
...
LIZ AI BRASIL Go include i seguenti limiti:
...
Il [model id](/docs/config/#models) nella tua LIZ AI BRASIL config
utilizza il formato `liz-go/<model-id>`. Ad esempio, per Kimi K2.6, useresti
`liz-go/kimi-k2.6` nella tua configurazione.
...
Abbiamo creato LIZ AI BRASIL Go per:
...
4. Non avere **nessun lock-in**, permettendoti di utilizzare anche qualsiasi altro provider con LIZ AI BRASIL.
