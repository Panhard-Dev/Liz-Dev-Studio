...
Puoi aggiungere comandi personalizzati tramite la config di LIZ AI BRASIL o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di LIZ AI BRASIL:
...
- Globale: `~/.config/liz/commands/`
- Per progetto: `.liz/commands/`
...
liz include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
