...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ LIZ AI BRASIL:
...
- ระดับผู้ใช้ (Global): `~/.config/liz/commands/`
- ระดับโปรเจ็กต์: `.liz/commands/`
...
LIZ AI BRASIL มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
