---
title: Paylasim
description: liz konusmalarini genel baglantilarla paylasin.
---

liz'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda liz:
...
liz, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak liz manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `liz.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda liz kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
