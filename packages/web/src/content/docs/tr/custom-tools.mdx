---
title: Özel Araçlar
description: LLM'un liz'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. liz'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.liz/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/liz/tools/` içine yerleştirerek.
