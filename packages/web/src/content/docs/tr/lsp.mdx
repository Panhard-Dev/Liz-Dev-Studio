...
description: LIZ AI BRASIL, LSP sunucularınızla bütünleşir.
---

LIZ AI BRASIL, LLM'in kod tabanınızla etkileşime girmesine yardımcı olmak için Dil Sunucusu Protokolünüzle (LSP) bütünleşir. LLM'ye geri bildirim sağlamak için tanılamayı kullanır.

---

## Yerleşik

LIZ AI BRASIL, popüler diller için çeşitli yerleşik LSP sunucularıyla birlikte gelir:
...
:::note
`LIZ_DISABLE_LSP_DOWNLOAD` ortam değişkenini `true` olarak ayarlayarak otomatik LSP sunucu indirmelerini devre dışı bırakabilirsiniz.
:::
...
LSP sunucularını, liz yapılandırmanızdaki `lsp` bölümü aracılığıyla özelleştirebilirsiniz.
