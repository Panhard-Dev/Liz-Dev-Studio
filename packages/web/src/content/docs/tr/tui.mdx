---
title: TUI
description: LIZ AI BRASIL terminal kullanıcı arayüzünü kullanma.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL, projelerinizde LLM ile çalışmak için etkileşimli bir terminal arayüzü (TUI) sunar.

LIZ AI BRASIL'u çalıştırdığınızda mevcut dizin için TUI başlar.
...
LIZ AI BRASIL TUI kullanırken `/` ve ardından komut adını yazarak hızlı eylemler çalıştırabilirsiniz. Örneğin:
...
LIZ AI BRASIL'a bir sağlayıcı ekler. Mevcut sağlayıcıları seçip API anahtarları eklemenizi sağlar.
...
LIZ AI BRASIL'dan çıkar. _Takma adlar_: `/quit`, `/q`
...
Bu, sunucu/çalışma zamanı davranışını yapılandıran `liz.json` dosyasından ayrıdır.
...
Özel bir TUI yapılandırma yolu yüklemek için `LIZ_TUI_CONFIG` kullanın.
