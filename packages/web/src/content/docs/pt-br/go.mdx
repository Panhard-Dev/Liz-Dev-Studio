...
O LIZ AI BRASIL Go é uma assinatura de baixo custo — **US$ 5 no seu primeiro mês**, depois **US$ 10/mês** — que oferece acesso confiável a modelos abertos de programação populares.

:::note
O LIZ AI BRASIL Go está atualmente em beta.
:::

O Go funciona como qualquer outro provedor no LIZ AI BRASIL. Você assina o LIZ AI BRASIL Go e
obtém a sua chave de API. Ele é **totalmente opcional** e você não precisa usá-lo para
usar o LIZ AI BRASIL.
...
O LIZ AI BRASIL Go lhe dá acesso a esses modelos por **US$ 5 no seu primeiro mês**, depois **US$ 10/mês**.

---

## Como funciona

O LIZ AI BRASIL Go funciona como qualquer outro provedor no LIZ AI BRASIL.

1. Você entra no **<a href={console}>LIZ AI BRASIL Zen</a>**, assina o Go e
   copia a sua chave de API.
2. Você executa o comando `/connect` na TUI, seleciona `LIZ AI BRASIL Go` e cola
   a sua chave de API.
3. Execute `/models` na TUI para ver a lista de modelos disponíveis através do Go.

:::note
Apenas um membro por workspace pode assinar o LIZ AI BRASIL Go.
:::
...
O LIZ AI BRASIL Go inclui os seguintes limites:
...
O [ID do modelo](/docs/config/#models) na sua configuração do LIZ AI BRASIL
usa o formato `liz-go/<model-id>`. Por exemplo, para o Kimi K2.6, você usaria
`liz-go/kimi-k2.6` na sua configuração.
...
Criamos o LIZ AI BRASIL Go para:
...
4. Não ter **nenhuma restrição de fornecedor (lock-in)**, permitindo que você use qualquer outro provedor com o LIZ AI BRASIL também.
