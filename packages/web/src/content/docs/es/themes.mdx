...
Con LIZ AI BRASIL puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, LIZ AI BRASIL usa nuestro propio tema `liz`.
...
LIZ AI BRASIL viene con varios temas integrados.
...
- Quiere que LIZ AI BRASIL coincida con la apariencia de su terminal
...
LIZ AI BRASIL admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/liz/themes/*.json` o `$XDG_CONFIG_HOME/liz/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.liz/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.liz/themes/*.json`
