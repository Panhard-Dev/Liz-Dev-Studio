---
title: Compartir
description: Comparte tus conversaciones LIZ AI BRASIL.
---

La función para compartir de LIZ AI BRASIL te permite crear enlaces públicos a tus conversaciones de LIZ AI BRASIL, para que puedas colaborar con compañeros de equipo u obtener ayuda de otros.
...
Cuando compartes una conversación, LIZ AI BRASIL:
...
LIZ AI BRASIL admite tres modos de compartir que controlan cómo se comparten las conversaciones:

---

### Manual (predeterminado)

De forma predeterminada, LIZ AI BRASIL usa el modo de compartir manual. Las sesiones no se comparten automáticamente, pero puedes compartirlas manualmente usando el comando `/share`:
...
Para aplicar esto en todo su equipo para un proyecto determinado, agréguelo al `liz.json` en su proyecto y regístrelo en Git.
...
[Obtenga más información](/docs/enterprise) sobre el uso de liz en su organización.
