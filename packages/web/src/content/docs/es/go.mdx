...
LIZ AI BRASIL Go es una suscripción de bajo costo — **$5 por tu primer mes**, luego **$10/mes** — que te brinda acceso confiable a modelos abiertos de programación populares.

:::note
LIZ AI BRASIL Go está actualmente en beta.
:::

Go funciona como cualquier otro proveedor en LIZ AI BRASIL. Te suscribes a LIZ AI BRASIL Go y
...
LIZ AI BRASIL Go te da acceso a estos modelos por **$5 por tu primer mes**, luego **$10/mes**.

---

## Cómo funciona

LIZ AI BRASIL Go funciona como cualquier otro proveedor en LIZ AI BRASIL.

1. Inicias sesión en **<a href={console}>LIZ AI BRASIL Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `LIZ AI BRASIL Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a LIZ AI BRASIL Go.
:::
...
LIZ AI BRASIL Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de LIZ AI BRASIL
usa el formato `liz-go/<model-id>`. Por ejemplo, para Kimi K2.6, usarías
`liz-go/kimi-k2.6` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con LIZ AI BRASIL.
