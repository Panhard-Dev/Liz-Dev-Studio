...
Puede agregar comandos personalizados a través de la configuración LIZ AI BRASIL o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su LIZ AI BRASIL [config](/docs/config):
...
liz incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
