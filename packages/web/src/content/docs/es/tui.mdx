---
title: TUI
description: Usando la interfaz de usuario del terminal LIZ AI BRASIL.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar LIZ AI BRASIL se inicia TUI para el directorio actual.
...
Cuando utilice LIZ AI BRASIL TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a LIZ AI BRASIL. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de LIZ AI BRASIL. _Alias_: `/quit`, `/q`
...
Esto es independiente de `liz.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `LIZ_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
