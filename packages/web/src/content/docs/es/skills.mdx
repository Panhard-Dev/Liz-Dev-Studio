...
Las habilidades del agente permiten a LIZ AI BRASIL descubrir instrucciones reutilizables de su repositorio o directorio de inicio.
...
LIZ AI BRASIL busca estas ubicaciones:

- Configuración del proyecto: `.liz/skills/<name>/SKILL.md`
- Configuración global: `~/.config/liz/skills/<name>/SKILL.md`
...
Para las rutas locales del proyecto, LIZ AI BRASIL sube desde su directorio de trabajo actual hasta llegar al árbol de trabajo de git.
Carga cualquier `skills/*/SKILL.md` coincidente en `.liz/` y cualquier `.claude/skills/*/SKILL.md` o `.agents/skills/*/SKILL.md` coincidente a lo largo del camino.

Las definiciones globales también se cargan desde `~/.config/liz/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` y `~/.agents/skills/*/SKILL.md`.
...
Crea `.liz/skills/git-release/SKILL.md` así:
...
LIZ AI BRASIL enumera las habilidades disponibles en la descripción de la herramienta `skill`.
...
Controle a qué agentes de habilidades pueden acceder utilizando permisos basados ​​en patrones en `liz.json`:
...
**Para agentes integrados** (en `liz.json`):
