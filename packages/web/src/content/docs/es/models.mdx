...
Los proveedores más populares están precargados de forma predeterminada. Si agregó las credenciales de un proveedor mediante el comando `/connect`, estarán disponibles cuando inicie LIZ AI BRASIL.
...
Aqui tienes varios modelos que funcionan bien con LIZ AI BRASIL, sin orden particular. (Esta no es una lista exhaustiva ni necesariamente actualizada):
...
configuracion de LIZ AI BRASIL.
...
Aquí el ID completo es `provider_id/model_id`. Por ejemplo, si usa [LIZ AI BRASIL Zen](/docs/zen), usaría `liz/gpt-5.1-codex` para GPT 5.1 Codex.
...
Muchos modelos admiten múltiples variantes con diferentes configuraciones. LIZ AI BRASIL se envía con variantes predeterminadas integradas para proveedores populares.

### Variantes integradas

LIZ AI BRASIL se envía con variantes predeterminadas para muchos proveedores:
...
Cuando se inicia LIZ AI BRASIL, busca modelos en el siguiente orden de prioridad:
...
2. La lista de modelos en la configuración LIZ AI BRASIL.
