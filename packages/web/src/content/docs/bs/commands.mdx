...
Možete dodati prilagođene komande kroz LIZ AI BRASIL konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom LIZ AI BRASIL [config](/docs/config):
...
- Globalno: `~/.config/liz/commands/`
- Po projektu: `.liz/commands/`
...
LIZ AI BRASIL uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
