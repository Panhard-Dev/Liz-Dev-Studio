...
Postoje dvije vrste agenata u LIZ AI BRASIL: primarni agenti i podagenti.
...
LIZ AI BRASIL dolazi sa dva ugrađena primarna agenta, **Build** i **Plan**. Pogledat ćemo ih u nastavku.
...
LIZ AI BRASIL dolazi sa dva ugrađena subagenta, **General** i **Explore**. Ovo ćemo pogledati u nastavku.

---

## Ugrađeni

LIZ AI BRASIL dolazi sa dva ugrađena primarna agenta i dva ugrađena subagenta.
...
Konfigurirajte agente u svom konfiguracijskom fajlu `liz.json`:
...
- Globalno: `~/.config/liz/agents/`
- Po projektu: `.liz/agents/`
...
Ako temperatura nije navedena, LIZ AI BRASIL koristi standardne postavke specifične za model; obično 0 za većinu modela, 0.55 za Qwen modele.
...
Ova putanja je relativna u odnosu na mjesto gdje se nalazi konfiguracijski fajl. Dakle, ovo radi i za globalnu LIZ AI BRASIL konfiguraciju i za konfiguraciju specifične za projekat.
...
ID modela u vašoj LIZ AI BRASIL konfiguraciji koristi format `provider/model-id`. Na primjer, ako koristite [LIZ AI BRASIL Zen](/docs/zen), koristili biste `liz/gpt-5.1-codex` za GPT 5.1 Codex.
...
:::tip
Pokrenite `liz models` da vidite listu dostupnih modela.
:::
...
:::tip
Imate li agenta kojeg biste željeli podijeliti? [Pošalji PR](https://github.com/anomalyco/liz).
:::
