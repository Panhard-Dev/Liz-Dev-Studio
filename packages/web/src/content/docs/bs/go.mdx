...
LIZ AI BRASIL Go je povoljna pretplata — **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno** — koja vam pruža pouzdan pristup popularnim otvorenim modelima za programiranje.

:::note
LIZ AI BRASIL Go je trenutno u beta fazi.
:::

Go radi kao bilo koji drugi provajder u LIZ AI BRASIL-u. Pretplatite se na LIZ AI BRASIL Go i
dobijete svoj API ključ. On je **potpuno opcionalan** i ne morate ga koristiti da
biste koristili LIZ AI BRASIL.
...
:::tip
Testirali smo odabranu grupu modela i provajdera koji dobro rade sa LIZ AI BRASIL-om.
:::
...
LIZ AI BRASIL Go vam daje pristup ovim modelima za **$5 za vaš prvi mjesec**, a zatim **$10/mjesečno**.

---

## Kako funkcioniše

LIZ AI BRASIL Go radi kao bilo koji drugi provajder u LIZ AI BRASIL-u.

1. Prijavite se na **<a href={console}>LIZ AI BRASIL Zen</a>**, pretplatite se na Go i
   kopirajte svoj API ključ.
2. Pokrenite komandu `/connect` u TUI-ju, odaberite `LIZ AI BRASIL Go` i zalijepite
   svoj API ključ.
3. Pokrenite `/models` u TUI-ju da vidite listu modela dostupnih kroz Go.

:::note
Samo jedan član po radnom prostoru (workspace) može se pretplatiti na LIZ AI BRASIL Go.
:::
...
LIZ AI BRASIL Go uključuje sljedeća ograničenja:
...
[Model id](/docs/config/#models) u vašoj LIZ AI BRASIL konfiguraciji
koristi format `liz-go/<model-id>`. Na primjer, za Kimi K2.6, koristili biste
`liz-go/kimi-k2.6` u svojoj konfiguraciji.
...
Napravili smo LIZ AI BRASIL Go da bismo:
...
4. Osigurali da **nema zaključavanja (no lock-in)**, omogućavajući vam da uz LIZ AI BRASIL koristite i bilo kojeg drugog provajdera.
