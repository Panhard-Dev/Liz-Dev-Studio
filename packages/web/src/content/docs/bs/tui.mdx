---
title: TUI
description: Korištenje korisničkog interfejsa LIZ AI BRASIL terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje LIZ AI BRASIL pokreće TUI za trenutni direktorij.
...
Kada koristite LIZ AI BRASIL TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u LIZ AI BRASIL. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz LIZ AI BRASIL. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `liz.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `LIZ_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
