...
Agent skills omogucavaju LIZ AI BRASIL da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
LIZ AI BRASIL pretrazuje ove lokacije:

- Konfiguracija projekta: `.liz/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/liz/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, LIZ AI BRASIL ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.liz/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/liz/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.liz/skills/git-release/SKILL.md` ovako:
...
LIZ AI BRASIL navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `liz.json`:
