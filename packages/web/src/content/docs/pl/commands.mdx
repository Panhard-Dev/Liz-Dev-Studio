...
Możesz zdefiniować polecenia w `liz.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji liz:
...
- Globalnie: `~/.config/liz/commands/`
- Na projekt: `.liz/commands/`
...
liz zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
