---
title: SDK
description: Typowany klient JS dla serwera LIZ AI BRASIL.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Pakiet SDK JS/TS LIZ AI BRASIL zapewnia klienta z bezpiecznym typowaniem (type-safe) do interakcji z serwerem.
Użyj go do budowania integracji i programowej kontroli LIZ AI BRASIL.
...
Utwórz instancję LIZ AI BRASIL:
...
Można przekazać obiekt konfiguracyjny, aby dostosować zachowanie. Instancja nadal pobiera `liz.json`, ale możesz zastąpić lub dodać konfigurację bezpośrednio:
...
Jeśli masz już działającą instancję LIZ AI BRASIL, możesz utworzyć instancję klienta, aby się z nią połączyć:
