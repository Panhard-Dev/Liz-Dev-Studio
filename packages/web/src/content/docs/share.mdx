---
title: Share
description: Share your LIZ AI BRASIL conversations.
---

LIZ AI BRASIL's share feature allows you to create public links to your LIZ AI BRASIL conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, LIZ AI BRASIL:
...
LIZ AI BRASIL supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, LIZ AI BRASIL uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `liz.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using liz in your organization.
