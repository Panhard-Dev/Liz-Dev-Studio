---
title: TUI
description: Brug af LIZ AI BRASIL-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre LIZ AI BRASIL starter TUI for den nuværende mappe.
...
Når du bruger LIZ AI BRASIL TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til LIZ AI BRASIL. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut LIZ AI BRASIL. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `liz.json`, som konfigurerer server-/kørselstidsadfærd.
...
Brug `LIZ_TUI_CONFIG` til at indlæse en brugerdefineret TUI-konfigurationssti.
