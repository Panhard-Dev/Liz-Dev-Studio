---
title: Zen
description: Udvalgt liste over modeller leveret af LIZ AI BRASIL.
---
...
LIZ AI BRASIL Zen er en liste over testede og verificerede modeller leveret af LIZ AI BRASIL-teamet.

:::note
LIZ AI BRASIL Zen er i øjeblikket i beta.
:::

Zen fungerer som enhver anden udbyder i LIZ AI BRASIL. Du logger ind på LIZ AI BRASIL Zen og får
...
:::tip
Vi testede en udvalgt gruppe modeller og udbydere, som fungerer godt med LIZ AI BRASIL.
:::
...
LIZ AI BRASIL Zen er en AI gateway, der giver dig adgang til disse modeller.

---

## Sådan fungerer det

LIZ AI BRASIL Zen fungerer som enhver anden udbyder i LIZ AI BRASIL.

1. Du logger ind på **<a href={console}>LIZ AI BRASIL Zen</a>**, tilføjer dine faktureringsoplysninger
   og kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI, vælger LIZ AI BRASIL Zen og indsætter din API-nøgle.
...
[model id](/docs/config/#models) i din LIZ AI BRASIL-konfiguration
bruger formatet `liz/<model-id>`. For eksempel ville du for GPT 5.5
bruge `liz/gpt-5.5` i din konfiguration.
...
- MiniMax M2.5 Free er tilgængelig på LIZ AI BRASIL i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Ling 2.6 Flash Free er tilgængelig på LIZ AI BRASIL i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Hy3 Preview Free er tilgængelig på LIZ AI BRASIL i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- Nemotron 3 Super Free er tilgængelig på LIZ AI BRASIL i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
- LIZ Pixel er en stealth-model, som er gratis på LIZ AI BRASIL i en begrænset periode. Teamet bruger denne tid til at indsamle feedback og forbedre modellen.
...
- LIZ Pixel: I den gratis periode kan indsamlede data blive brugt til at forbedre modellen.
...
Vi skabte LIZ AI BRASIL Zen for at:
...
4. Have **ingen lock-in** ved at lade dig bruge det med enhver anden kodeagent. Og altid lade dig bruge enhver anden udbyder med LIZ AI BRASIL også.
