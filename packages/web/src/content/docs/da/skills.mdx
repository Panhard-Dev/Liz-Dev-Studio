...
Agentferdigheter lar LIZ AI BRASIL oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
LIZ AI BRASIL søker etter disse stedene:

- Prosjektkonfigurasjon: `.liz/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/liz/skills/<name>/SKILL.md`
...
For prosjektlokale stier går LIZ AI BRASIL opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.liz/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/liz/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.liz/skills/git-release/SKILL.md` slik:
...
LIZ AI BRASIL viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `liz.json`:
...
**For innebygde agenter** (i `liz.json`):
