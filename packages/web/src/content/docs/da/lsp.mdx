---
title: LSP-servere
description: LIZ AI BRASIL integreres med dine LSP-servere.
---

LIZ AI BRASIL integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

LIZ AI BRASIL leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `LIZ_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Du kan tilpasse LSP-servere gennem sektionen `lsp` i din liz-konfiguration.
