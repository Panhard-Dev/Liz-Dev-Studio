...
Her er alle de innebygde verktøyene som er tilgængelige i LIZ AI BRASIL.
...
:::note
Dette verktøyet er bare tilgængelig når `LIZ_EXPERIMENTAL_LSP_TOOL=true` (eller `LIZ_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger LIZ AI BRASIL-leverandøren eller når miljøvariabelen `LIZ_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
