...
Der er to typer agenter i LIZ AI BRASIL; primære agenter og subagenter.
...
LIZ AI BRASIL leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
LIZ AI BRASIL leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

LIZ AI BRASIL leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `liz.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger LIZ AI BRASIL modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne sti er i forhold til, hvor konfigurationsfilen er placeret. Så dette virker både for den globale LIZ AI BRASIL-konfiguration og den projektspecifikke konfiguration.
...
Model-id'et i din LIZ AI BRASIL-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [LIZ AI BRASIL Zen](/docs/zen), vil du bruge `liz/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `liz models` for at se en liste over de tilgængelige modeller.
:::
...
:::tip
Har du en agent, du gerne vil dele? [Send en PR](https://github.com/anomalyco/liz).
:::
