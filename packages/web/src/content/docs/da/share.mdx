---
title: Deling
description: Del dine LIZ AI BRASIL-samtaler.
---

LIZ AI BRASILs delingsfunksjon lar deg lage offentlige lenker til dine LIZ AI BRASIL-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, LIZ AI BRASIL:
...
LIZ AI BRASIL støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuel (standard)

Som standard bruger LIZ AI BRASIL manuell delingsmodus. Sessioner deles ikke automatisk, men du kan dele dem manuelt ved at bruge kommandoen `/share`:
...
For at håndheve dette på tvers av teamet ditt for et gitt prosjekt, tilføj det til `liz.json` i prosjektet ditt og tjek inn i Git.
...
[Finn ut mer](/docs/enterprise) om brug av liz i organisasjonen din.
