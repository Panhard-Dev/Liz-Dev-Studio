...
You can add custom commands through the LIZ AI BRASIL config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your LIZ AI BRASIL [config](/docs/config):
...
liz includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
