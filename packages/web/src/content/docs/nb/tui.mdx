---
title: TUI
description: Bruke liz-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

LIZ AI BRASIL gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre LIZ AI BRASIL starter TUI for gjeldende katalog.
...
Når du bruker LIZ AI BRASIL TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til LIZ AI BRASIL. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt LIZ AI BRASIL. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `liz.json`, som konfigurerer server-/kjøretidsoppførsel.
...
Bruk `LIZ_TUI_CONFIG` for å laste en egendefinert TUI-konfigurasjonsbane.
