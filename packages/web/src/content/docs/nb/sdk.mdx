---
title: SDK
description: Typesikker JS-klient for LIZ AI BRASIL-server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

LIZ AI BRASIL JS/TS SDK gir en typesikker klient for samhandling med serveren.
Bruk den til å bygge integrasjoner og kontrollere LIZ AI BRASIL programmatisk.
...
Opprett en forekomst av LIZ AI BRASIL:
...
Du kan sende et konfigurasjonsobjekt for å tilpasse virkemåten. Forekomsten henter fortsatt din `liz.json`, men du kan overstyre eller legge til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av LIZ AI BRASIL, kan du opprette en klientforekomst for å koble til den:
