...
Agentferdigheter lar LIZ AI BRASIL oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går liz opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
liz viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `liz.json`:
