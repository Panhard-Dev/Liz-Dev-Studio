...
description: Lag verktøy som LLM kan kalle inn LIZ AI BRASIL.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med LIZ AI BRASIL sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.liz/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/liz/tools/`.
