...
Det er to typer agenter i LIZ AI BRASIL; primære agenter og underagenter.
...
LIZ AI BRASIL kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
LIZ AI BRASIL kommer med to innebygde underagenter, **General** og **Explore**. Vi skal se på dette nedenfor.

---

## Innebygd

LIZ AI BRASIL kommer med to innebygde primære agenter og to innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `liz.json`:
...
- Globalt: `~/.config/liz/agents/`
- Per prosjekt: `.liz/agents/`
...
Hvis ingen temperatur er spesifisert, bruker LIZ AI BRASIL modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale LIZ AI BRASIL-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i LIZ AI BRASIL-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [LIZ AI BRASIL Zen](/docs/zen), vil du bruke `liz/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `liz models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/anomalyco/liz).
:::
