---
title: LSP-servere
description: liz integreres med LSP-serverne dine.
---

LIZ AI BRASIL integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

LIZ AI BRASIL kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `LIZ_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Du kan tilpasse LSP-servere gjennom `lsp`-delen i LIZ AI BRASIL-konfigurasjonen.
