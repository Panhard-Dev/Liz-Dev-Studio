...
LIZ AI BRASIL Go er et lavkostnadsabonnement — **$5 for din første måned**, deretter **$10/måned** — som gir deg pålitelig tilgang til populære åpne kodemodeller.

:::note
LIZ AI BRASIL Go er for øyeblikket i beta.
:::

Go fungerer som enhver annen leverandør i LIZ AI BRASIL. Du abonnerer på LIZ AI BRASIL Go og
...
LIZ AI BRASIL Go gir deg tilgang til disse modellene for **$5 for din første måned**, deretter **$10/måned**.

---

## Hvordan det fungerer

LIZ AI BRASIL Go fungerer som enhver annen leverandør i LIZ AI BRASIL.

1. Du logger inn på **<a href={console}>LIZ AI BRASIL Zen</a>**, abonnerer på Go, og
   kopierer din API-nøkkel.
2. Du kjører kommandoen `/connect` i TUI-en, velger `LIZ AI BRASIL Go`, og limer inn
   din API-nøkkel.
3. Kjør `/models` i TUI-en for å se listen over modeller som er tilgjengelige gjennom Go.

:::note
Kun ett medlem per arbeidsområde kan abonnere på LIZ AI BRASIL Go.
:::
...
LIZ AI BRASIL Go inkluderer følgende grenser:
...
[Modell-ID-en](/docs/config/#models) i din LIZ AI BRASIL-konfigurasjon
bruker formatet `liz-go/<model-id>`. For eksempel, for Kimi K2.6, vil du
bruke `liz-go/kimi-k2.6` i konfigurasjonen din.
...
Vi opprettet LIZ AI BRASIL Go for å:
...
4. Ha **ingen innelåsing** ved å la deg bruke en hvilken som helst annen leverandør med LIZ AI BRASIL også.
