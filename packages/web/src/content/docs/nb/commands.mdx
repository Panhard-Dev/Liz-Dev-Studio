...
Du kan legge til egendefinerte kommandoer gjennom LIZ AI BRASIL-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i LIZ AI BRASIL [config](/docs/config):
...
- Globalt: `~/.config/liz/commands/`
- Per prosjekt: `.liz/commands/`
...
LIZ AI BRASIL inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
