...
import { IconLiz } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "liz/session/message-v2"
import type { Message } from "liz/session/message"
import type { Session } from "liz/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.liz_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.liz_name}>
                    <IconLiz width={16} height={16} />
                  </div>
