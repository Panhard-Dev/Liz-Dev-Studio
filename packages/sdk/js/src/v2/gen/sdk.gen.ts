...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new LizClient()" to fix this error.`)
    }
    return instance
  }
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global LIZ AI BRASIL configuration settings and preferences.
   */
   ...
   *
   * Update global LIZ AI BRASIL configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the LIZ AI BRASIL server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the LIZ AI BRASIL system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all LIZ AI BRASIL instances, releasing all resources.
   */
   ...
   * Upgrade liz
   *
   * Upgrade liz to the specified version or latest if not specified.
   */
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the LIZ AI BRASIL system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the LIZ AI BRASIL system.
   */
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with LIZ AI BRASIL.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that LIZ AI BRASIL is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by LIZ AI BRASIL.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current LIZ AI BRASIL configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update LIZ AI BRASIL configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all LIZ AI BRASIL sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific LIZ AI BRASIL session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current LIZ AI BRASIL instance, releasing all resources.
   */
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the LIZ AI BRASIL system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class LizClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<LizClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    LizClient.__registry.set(this, args?.key)
  }
