import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@liz-ai-brasil/sdk/v2"
import { SessionTurn } from "@liz-ai-brasil/ui/session-turn"
import { SessionReview } from "@liz-ai-brasil/ui/session-review"
import { DataProvider } from "@liz-ai-brasil/ui/context"
import { FileComponentProvider } from "@liz-ai-brasil/ui/context/file"
import { WorkerPoolProvider } from "@liz-ai-brasil/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@liz-ai-brasil/ui/logo"
import { IconButton } from "@liz-ai-brasil/ui/icon-button"
import { ProviderIcon } from "@liz-ai-brasil/ui/provider-icon"
import { iife } from "@liz-ai-brasil/core/util/iife"
...
import { Tabs } from "@liz-ai-brasil/ui/tabs"
import { MessageNav } from "@liz-ai-brasil/ui/message-nav"
import { FileSSR } from "@liz-ai-brasil/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@liz-ai-brasil/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/liz-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | LIZ AI BRASIL</Title>
              </Show>
              <Meta name="description" content="liz - The AI coding agent built for the terminal." />
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              <IconButton
                                as={"a"}
                                href="https://github.com/anomalyco/liz"
                                target="_blank"
                                icon="github"
                                variant="ghost"
                              />
