...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips liz-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-liz-directory"]).toBeUndefined()
      expect(forwarded["x-liz-workspace"]).toBeUndefined()
