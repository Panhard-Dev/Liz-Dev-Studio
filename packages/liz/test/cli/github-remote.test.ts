...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/liz.git")).toEqual({ owner: "sst", repo: "liz" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/liz")).toEqual({ owner: "sst", repo: "liz" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/liz.git")).toEqual({ owner: "sst", repo: "liz" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/liz")).toEqual({ owner: "sst", repo: "liz" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/liz.git")).toEqual({ owner: "sst", repo: "liz" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/liz")).toEqual({ owner: "sst", repo: "liz" })
})
