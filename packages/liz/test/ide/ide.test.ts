...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders LIZ_CALLER", () => {
    process.env["LIZ_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode LIZ_CALLER", () => {
    process.env["LIZ_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown LIZ_CALLER", () => {
    process.env["LIZ_CALLER"] = "unknown"
