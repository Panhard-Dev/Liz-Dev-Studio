...
import type { Event, EventMessagePartUpdated, ToolStatePending, ToolStateRunning } from "@liz-ai-brasil/sdk/v2"
...
function createFakeAgent() {
            ...
            providers: [
              {
                ...
                name: "liz",
                models: {
                  "liz-pixel": { id: "liz-pixel", name: "liz-pixel" },
                },
              },
            ],
          },
  ...
  const agent = new ACP.Agent(connection, {
    sdk,
    defaultModel: { providerID: "liz", modelID: "liz-pixel" },
  } as any)
