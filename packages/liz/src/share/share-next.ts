import type * as SDK from "@liz-ai-brasil/sdk/v2"
...
const disabled = process.env["LIZ_DISABLE_SHARE"] === "true" || process.env["LIZ_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@liz/ShareNext") {}
