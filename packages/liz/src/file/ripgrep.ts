...
import { sanitizedProcessEnv } from "@liz-ai-brasil/core/util/liz-process"
...
export class Service extends Context.Service<Service, Interface>()("@liz/Ripgrep") {}
