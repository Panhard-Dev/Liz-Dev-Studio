...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the LIZ AI BRASIL server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the LIZ AI BRASIL system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global LIZ AI BRASIL configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global LIZ AI BRASIL configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all LIZ AI BRASIL instances, releasing all resources.",
    ...
    .post(
      ...
      describeRoute({
        summary: "Upgrade liz",
        description: "Upgrade liz to the specified version or latest if not specified.",
