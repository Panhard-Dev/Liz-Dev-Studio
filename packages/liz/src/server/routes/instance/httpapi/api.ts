...
export const RootHttpApi = HttpApi.make("liz-root").addHttpApi(ControlApi).addHttpApi(GlobalApi)

export const InstanceHttpApi = HttpApi.make("liz-instance")
...
export const LizHttpApi = HttpApi.make("liz")
