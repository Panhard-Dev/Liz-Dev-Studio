...
>()("@liz/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@liz/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceID | undefined {
  return Flag.LIZ_WORKSPACE_ID ? WorkspaceID.make(Flag.LIZ_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-liz-directory"] || currentDirectory()
}
