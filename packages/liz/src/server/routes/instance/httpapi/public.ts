...
const LegacyComponentDescriptions = {
  LogLevel: "Log level",
  ServerConfig: "Server configuration for liz serve and web commands",
...
function fixSelfReferencingComponents(spec: OpenApiSpec) {
  ...
  const raw = OpenApi.fromApi(LizHttpApi) as unknown as OpenApiSpec
...
export const PublicApi = LizHttpApi.annotateMerge(
  OpenApi.annotations({
    title: "liz",
    version: "1.0.0",
    description: "liz api",
