 ...
 *   "@liz/ServerAuthConfig",
 *   {
 *     password: Config.string("LIZ_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("LIZ_SERVER_USERNAME").pipe(Config.withDefault("liz")),
 *   },
 * ) {}
 *
