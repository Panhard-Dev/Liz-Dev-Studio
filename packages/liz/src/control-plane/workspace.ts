...
export class Service extends Context.Service<Service, Interface>()("@liz/Workspace") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const startSync = Effect.fn("Workspace.startSync")(function* (space: Info) {
      if (!Flag.LIZ_EXPERIMENTAL_WORKSPACES) return
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        LIZ_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        LIZ_WORKSPACE_ID: config.id,
        LIZ_EXPERIMENTAL_WORKSPACES: "true",
