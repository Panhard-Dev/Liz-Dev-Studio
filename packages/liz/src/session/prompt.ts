...
import * as EffectLogger from "@liz-ai-brasil/core/effect/logger"
...
export class Service extends Context.Service<Service, Interface>()("@liz/SessionPrompt") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const insertReminders = Effect.fn("SessionPrompt.insertReminders")(function* (input: {
      ...
      if (!Flag.LIZ_EXPERIMENTAL_PLAN_MODE) {
