...
Practical reference for the current tool-migration state in `packages/liz`.
...
Tool tests should use the existing Effect helpers in `packages/liz/test/lib/effect.ts`:
