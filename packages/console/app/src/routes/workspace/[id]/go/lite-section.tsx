...
import { Database, eq, and, isNull } from "@liz-ai-brasil/console-core/drizzle/index.js"
import { BillingTable, LiteTable } from "@liz-ai-brasil/console-core/schema/billing.sql.js"
        ...
        {(sub) => (
          <section class={styles.root}>
            ...
            <div data-slot="beta-notice">
              ...
              <a href={language.route("/docs/providers/#liz-go")} target="_blank" rel="noopener noreferrer">
