...
import desktopAppIcon from "../../asset/lander/liz-desktop-icon.png"
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g liz-ai-brasil")}>
                <code>
                  npm i -g <strong>liz-ai-brasil</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g liz-ai-brasil")}>
                <code>
                  bun add -g <strong>liz-ai-brasil</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/liz")}>
                <code>
                  brew install <strong>anomalyco/tap/liz</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S liz")}>
                <code>
                  paru -S <strong>liz</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask liz-desktop")}>
                <code>
                  brew install --cask <strong>liz-desktop</strong>
                </code>
                <CopyStatus />
              </button>
