...
import { and, Database, eq, isNull, lt, or, sql } from "@liz-ai-brasil/console-core/drizzle/index.js"
import { KeyTable } from "@liz-ai-brasil/console-core/schema/key.sql.js"
import { BillingTable, LiteTable, SubscriptionTable, UsageTable } from "@liz-ai-brasil/console-core/schema/billing.sql.js"
import { centsToMicroCents } from "@liz-ai-brasil/console-core/util/price.js"
import { getMonthlyBounds, getWeekBounds } from "@liz-ai-brasil/console-core/util/date.js"
import { Identifier } from "@liz-ai-brasil/console-core/identifier.js"
import { Billing } from "@liz-ai-brasil/console-core/billing.js"
import { Actor } from "@liz-ai-brasil/console-core/actor.js"
...
import { Subscription } from "@liz-ai-brasil/console-core/subscription.js"
import { BlackData } from "@liz-ai-brasil/console-core/black.js"
import { UserTable } from "@liz-ai-brasil/console-core/schema/user.sql.js"
import { ModelTable } from "@liz-ai-brasil/console-core/schema/model.sql.js"
import { ProviderTable } from "@liz-ai-brasil/console-core/schema/provider.sql.js"
...
import { LiteData } from "@liz-ai-brasil/console-core/lite.js"
import { Resource } from "@liz-ai-brasil/console-resource"
...
export async function handler(
  ...
  try {
    ...
    const sessionId = input.request.headers.get("x-liz-session") ?? ""
    const requestId = input.request.headers.get("x-liz-request") ?? ""
    const projectId = input.request.headers.get("x-liz-project") ?? ""
    const ocClient = input.request.headers.get("x-liz-client") ?? ""
    ...
    const retriableRequest = async (retry: RetryOptions = { excludeProviders: [], retryCount: 0 }) => {
      ...
      const res = await fetchWith429Retry(reqUrl, {
        ...
        headers: (() => {
          ...
          headers.delete("x-liz-request")
          headers.delete("x-liz-session")
          headers.delete("x-liz-project")
          headers.delete("x-liz-client")
          return headers
        })(),
        body: reqBody,
      })
  ...
  function validateBilling(authInfo: AuthInfo, modelInfo: ModelInfo): BillingSource {
    ...
    const billingUrl = `https://liz.ai/workspace/${authInfo.workspaceID}/billing`
    const membersUrl = `https://liz.ai/workspace/${authInfo.workspaceID}/members`
