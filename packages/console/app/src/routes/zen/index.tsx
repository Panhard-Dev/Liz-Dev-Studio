...
import compareVideo from "../../asset/lander/liz-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/liz-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="liz:auth" content={loggedin() ? "true" : "false"} />
