...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>LIZ AI BRASIL | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="LIZ AI BRASIL terms of service" />
          ...
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                ...
                our site located at liz.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using LIZ AI BRASIL?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by LIZ AI BRASIL;
                </li>
                <li>
              ...
              <p>
                LIZ AI BRASIL has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-liz-ever-change-the-services">Will LIZ AI BRASIL ever change the Services?</h2>
              <p>
              ...
              <p>
                ...
                <a href="https://liz.ai/auth">https://liz.ai/auth</a>.
              </p>
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the LIZ AI BRASIL Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without LIZ AI BRASIL's prior written
              ...
              <p>
                ...
                agreement permits either you or LIZ AI BRASIL to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and LIZ AI BRASIL agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                relationship with LIZ AI BRASIL.
              </p>
