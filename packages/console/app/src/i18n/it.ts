...
export const dict = {
  ...
  "home.what.body":
    "LIZ AI BRASIL è un agente open source che ti aiuta a scrivere codice nel terminale, IDE o desktop.",
  ...
  "zen.how.body":
    "Anche se ti consigliamo di utilizzare Zen con LIZ AI BRASIL, puoi utilizzare Zen con qualsiasi agente.",
  ...
  "download.faq.a6.p1":
    "I tuoi dati e informazioni sono archiviati solo quando crei link condivisibili in LIZ AI BRASIL.",
