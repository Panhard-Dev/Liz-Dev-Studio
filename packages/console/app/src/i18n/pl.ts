...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | liz",
  "notFound.heading": "404 - Nie znaleziono strony",
  "notFound.home": "Strona główna",
  "notFound.docs": "Dokumentacja",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "jasne logo liz",
  "notFound.logoDarkAlt": "ciemne logo liz",
  ...
  "app.meta.description": "LIZ AI BRASIL - Otwartoźródłowy agent programistyczny.",

  "home.title": "LIZ AI BRASIL | Open source'owy agent AI do kodowania",

  "temp.title": "liz | Agent AI do kodowania zbudowany dla terminala",
  ...
  "temp.feature.zen.afterLink": "dostarczana przez liz",
  "temp.feature.models.beforeLink": "Obsługuje 75+ dostawców LLM przez",
  "temp.feature.models.afterLink": ", w tym modele lokalne",
  "temp.screenshot.caption": "LIZ AI BRASIL TUI z motywem tokyonight",
  "temp.screenshot.alt": "LIZ AI BRASIL TUI z motywem tokyonight",
  "temp.logoLightAlt": "jasne logo liz",
  "temp.logoDarkAlt": "ciemne logo liz",
  ...
  "home.what.title": "Czym jest LIZ AI BRASIL?",
  "home.what.body":
    "LIZ AI BRASIL to open source'owy agent, który pomaga pisać kod w terminalu, IDE lub aplikacji desktopowej.",
  ...
  "home.growth.body":
    "Z ponad <strong>{{stars}}</strong> gwiazdkami na GitHubie, <strong>{{contributors}}</strong> współtwórcami i ponad <strong>{{commits}}</strong> commitami, LIZ AI BRASIL jest używany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperów każdego miesiąca.",
  ...
  "home.privacy.body":
    "LIZ AI BRASIL nie przechowuje Twojego kodu ani danych kontekstowych, dzięki czemu może działać w środowiskach wrażliwych na prywatność.",
  "home.privacy.learnMore": "Dowiedz się więcej o",
  "home.privacy.link": "prywatności",

  "home.faq.q1": "Czym jest LIZ AI BRASIL?",
  "home.faq.a1":
    "LIZ AI BRASIL to open source'owy agent, który pomaga pisać i uruchamiać kod z dowolnym modelem AI. Jest dostępny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystać z LIZ AI BRASIL?",
  "home.faq.a2.before": "Najłatwiej zacząć od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuję dodatkowych subskrypcji AI, aby używać LIZ AI BRASIL?",
  "home.faq.a3.p1":
    "Niekoniecznie. LIZ AI BRASIL posiada zestaw darmowych modeli, z których możesz korzystać bez zakładania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym możesz używać dowolnych popularnych modeli do kodowania, tworząc konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Chociaż zachęcamy do korzystania z Zen, LIZ AI BRASIL działa również ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",
  "home.faq.a3.p4.beforeLocal": "Możesz nawet podłączyć swoje",
  "home.faq.a3.p4.localLink": "lokalne modele",
  "home.faq.q4": "Czy mogę używać moich istniejących subskrypcji AI z LIZ AI BRASIL?",
  "home.faq.a4.p1":
    "Tak, LIZ AI BRASIL obsługuje plany subskrypcyjne od wszystkich głównych dostawców. Możesz używać swoich subskrypcji Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy mogę używać LIZ AI BRASIL tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Już nie! LIZ AI BRASIL jest teraz dostępny jako aplikacja na",
  "home.faq.a5.desktop": "pulpit (desktop)",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje LIZ AI BRASIL?",
  "home.faq.a6":
    "LIZ AI BRASIL jest w 100% darmowy. Zawiera również zestaw darmowych modeli. Mogą pojawić się dodatkowe koszty, jeśli podłączysz innego dostawcę.",
  ...
  "home.faq.q8": "Czy LIZ AI BRASIL jest open source?",
  "home.faq.a8.p1": "Tak, LIZ AI BRASIL jest w pełni open source. Kod źródłowy jest publicznie dostępny na",
  ...
  "zen.faq.q1": "Czym jest LIZ AI BRASIL Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i sprawdzonych pod kątem agentów kodujących, stworzony przez zespół stojący za LIZ AI BRASIL.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty od dostawców modeli bezpośrednio do Ciebie. Im większe użycie Zen, tym lepsze stawki LIZ AI BRASIL może wynegocjować i przekazać Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryć koszty, LIZ AI BRASIL dolicza jedynie niewielką opłatę za przetwarzanie płatności w wysokości $1.23 przy każdym doładowaniu salda o $20.",
  ...
  "zen.faq.a8":
    "Chociaż Zen świetnie działa z LIZ AI BRASIL, możesz używać Zen z dowolnym agentem. Postępuj zgodnie z instrukcjami konfiguracji w swoim preferowanym agencie.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników LIZ AI BRASIL.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z LIZ AI BRASIL, możesz używać Zen z dowolnym agentem.",
  ...
  "go.title": "LIZ AI BRASIL Go | Niskokosztowe modele do kodowania dla każdego",
  "go.meta.description":
  ...
  "go.graph.freePill": "LIZ Pixel i darmowe modele",
  "go.graph.go": "Go",
  ...
  "go.problem.body":
    "Skupiamy się na udostępnieniu doświadczenia LIZ AI BRASIL jak największej liczbie osób. LIZ AI BRASIL Go to tania subskrypcja: $5 za pierwszy miesiąc, potem $10/miesiąc. Zapewnia hojne limity i niezawodny dostęp do najbardziej wydajnych modeli open source.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go zaczyna się od $5 za pierwszy miesiąc, potem $10/miesiąc. Możesz go używać z LIZ AI BRASIL lub dowolnym agentem.",
  ...
  "go.faq.q1": "Czym jest LIZ AI BRASIL Go?",
  "go.faq.a1":
  ...
  "black.workspace.title": "LIZ AI BRASIL Black | Wybierz obszar roboczy",
  "black.workspace.selectPlan": "Wybierz obszar roboczy dla tego planu",
  "black.workspace.name": "Obszar roboczy {{n}}",
  "black.subscribe.title": "Subskrybuj LIZ AI BRASIL Black",
  ...
  "black.subscribe.success.title": "Jesteś na liście oczekujących LIZ AI BRASIL Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z LIZ AI BRASIL, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz liz",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom liz i wpisz",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API do usług liz.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wpisz nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz API bramy liz",
  ...
  "workspace.black.subscription.message": "Subskrybujesz LIZ AI BRASIL Black za ${{plan}} miesięcznie.",
  ...
  "workspace.lite.subscription.message": "Subskrybujesz LIZ AI BRASIL Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Wybierz "LIZ AI BRASIL Go" jako dostawcę w konfiguracji liz, aby używać modeli Go.',
  "workspace.lite.black.message":
    "Obecnie subskrybujesz LIZ AI BRASIL Black lub jesteś na liście oczekujących. Jeśli chcesz przejść na Go, najpierw anuluj subskrypcję.",
  "workspace.lite.other.message":
    "Inny członek tego obszaru roboczego już subskrybuje LIZ AI BRASIL Go. Tylko jeden członek na obszar roboczy może subskrybować.",
  "workspace.lite.promo.description":
    "LIZ AI BRASIL Go zaczyna się od {{price}}, potem $10/miesiąc, i zapewnia niezawodny dostęp do popularnych otwartych modeli kodowania z hojnymi limitami użycia.",
  ...
  "download.title": "LIZ AI BRASIL | Pobierz",
  "download.meta.description": "Pobierz LIZ AI BRASIL na macOS, Windows i Linux",
  "download.hero.title": "Pobierz LIZ AI BRASIL",
  "download.hero.subtitle": "Dostępne w wersji Beta na macOS, Windows i Linux",
  "download.hero.button": "Pobierz na {{os}}",
  "download.section.terminal": "Terminal LIZ AI BRASIL",
  "download.section.desktop": "Pulpit LIZ AI BRASIL (Beta)",
  "download.section.extensions": "Rozszerzenia LIZ AI BRASIL",
  "download.section.integrations": "Integracje LIZ AI BRASIL",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Będziesz potrzebować subskrypcji AI, jeśli chcesz połączyć LIZ AI BRASIL z płatnym dostawcą, chociaż możesz pracować z",
  ...
  "download.faq.a3.afterZen":
    ", LIZ AI BRASIL współpracuje ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itp.",

  "download.faq.a5.p1": "LIZ AI BRASIL jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty będą pochodzić z Twojej subskrypcji u dostawcy modelu. Chociaż LIZ AI BRASIL współpracuje z dowolnym dostawcą modeli, zalecamy korzystanie z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje są przechowywane tylko wtedy, gdy tworzysz linki do udostępniania w LIZ AI BRASIL.",
  "download.faq.a6.p2.beforeShare": "Dowiedz się więcej o",
  "download.faq.a6.shareLink": "stronach udostępniania",

  "enterprise.title": "LIZ AI BRASIL | Rozwiązania Enterprise dla Twojej organizacji",
  "enterprise.meta.description": "Skontaktuj się z LIZ AI BRASIL w sprawie rozwiązań dla przedsiębiorstw",
  "enterprise.hero.title": "Twój kod jest Twój",
  "enterprise.hero.body1":
    "LIZ AI BRASIL działa bezpiecznie wewnątrz Twojej organizacji bez przechowywania danych czy kontekstu, oraz bez ograniczeń licencyjnych czy roszczeń własnościowych. Rozpocznij okres próbny ze swoim zespołem, a następnie wdróż go w całej organizacji, integrując z SSO i wewnętrzną bramą AI.",
  ...
  "enterprise.faq.q1": "Czym jest LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a1":
    "LIZ AI BRASIL Enterprise jest dla organizacji, które chcą mieć pewność, że ich kod i dane nigdy nie opuszczą ich infrastruktury. Można to osiągnąć dzięki scentralizowanej konfiguracji, która integruje się z Twoim SSO i wewnętrzną bramą AI.",
  "enterprise.faq.q2": "Jak zacząć z LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a2":
    "Po prostu rozpocznij wewnętrzny okres próbny ze swoim zespołem. LIZ AI BRASIL domyślnie nie przechowuje Twojego kodu ani danych kontekstowych, co ułatwia start. Następnie skontaktuj się z nami, aby omówić opcje cenowe i wdrożeniowe.",
  ...
  "enterprise.faq.q4": "Czy moje dane są bezpieczne z LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a4":
    "Tak. LIZ AI BRASIL nie przechowuje Twojego kodu ani danych kontekstowych. Całe przetwarzanie odbywa się lokalnie lub poprzez bezpośrednie wywołania API do Twojego dostawcy AI. Dzięki centralnej konfiguracji i integracji SSO, Twoje dane pozostają bezpieczne w infrastrukturze Twojej organizacji.",

  "brand.title": "LIZ AI BRASIL | Marka",
  "brand.meta.description": "Wytyczne marki LIZ AI BRASIL",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i aktywa, które pomogą Ci pracować z marką LIZ AI BRASIL.",
  "brand.downloadAll": "Pobierz wszystkie zasoby",

  "changelog.title": "LIZ AI BRASIL | Dziennik zmian",
  "changelog.meta.description": "Notatki o wydaniu i dziennik zmian LIZ AI BRASIL",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia LIZ AI BRASIL",
