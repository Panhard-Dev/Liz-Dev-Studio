...
export const dict = {
  ...
  "workspace.black.waitlist.ready":
    "เราพร้อมที่จะลงทะเบียนให้คุณเข้าสู่แผน LIZ AI BRASIL Black ราคา ${{plan}} ต่อเดือนแล้ว",
  ...
  "download.faq.a3.afterZen":
    ", LIZ AI BRASIL ก็ทำงานร่วมกับผู้ให้บริการยอดนิยมทั้งหมด เช่น OpenAI, Anthropic, xAI เป็นต้น",
