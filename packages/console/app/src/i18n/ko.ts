...
export const dict = {
  ...
  "home.faq.a3.p1":
    "꼭 그렇지는 않습니다. LIZ AI BRASIL에는 계정 없이도 사용할 수 있는 무료 모델 세트가 포함되어 있습니다.",
  ...
  "go.how.body":
    "Go는 첫 달 $5, 이후 $10/월로 시작합니다. LIZ AI BRASIL 또는 어떤 에이전트와도 함께 사용할 수 있습니다.",
  ...
  "download.faq.a3.afterZen":
    " 사용을 권장하지만, LIZ AI BRASIL는 OpenAI, Anthropic, xAI 등 모든 인기 제공자와 작동합니다.",
