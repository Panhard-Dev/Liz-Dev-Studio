export const dict = {
  ...
  "home.what.body":
    "LIZ AI BRASIL is an open source agent that helps you write code in your terminal, IDE, or desktop.",
  ...
  "zen.faq.a4.p3":
    "To cover costs, LIZ AI BRASIL adds only a small payment processing fee of $1.23 per $20 balance top-up.",
  ...
  "go.how.body":
    "Go starts at $5 for your first month, then $10/month. You can use it with LIZ AI BRASIL or any agent.",
