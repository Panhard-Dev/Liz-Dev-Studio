...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | liz",
  "notFound.heading": "404 - Side ikke funnet",
  "notFound.home": "Hjem",
  "notFound.docs": "Dokumentasjon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "liz logo lys",
  "notFound.logoDarkAlt": "liz logo mørk",
  ...
  "app.meta.description": "LIZ AI BRASIL - Den åpne kildekode kodingsagenten.",

  "home.title": "LIZ AI BRASIL | Den åpne kildekode AI-kodingsagenten",

  "temp.title": "liz | AI-kodingsagent bygget for terminalen",
  ...
  "temp.feature.zen.afterLink": "levert av liz",
  ...
  "temp.screenshot.caption": "liz TUI med tokyonight-tema",
  "temp.screenshot.alt": "liz TUI med tokyonight-tema",
  "temp.logoLightAlt": "liz logo lys",
  "temp.logoDarkAlt": "liz logo mørk",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes LIZ AI BRASIL av over <strong>{{monthlyUsers}}</strong> utviklere hver måned.",
  ...
  "home.privacy.body":
    "LIZ AI BRASIL lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljøer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er LIZ AI BRASIL?",
  "home.faq.a1":
    "LIZ AI BRASIL er en åpen kildekode-agent som hjelper deg å skrive og kjøre kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg LIZ AI BRASIL?",
  "home.faq.a2.before": "Den enkleste måten å komme i gang på er å lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for å bruke LIZ AI BRASIL?",
  "home.faq.a3.p1":
    "Ikke nødvendigvis. LIZ AI BRASIL kommer med et sett gratis modeller du kan bruke uten å opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved å opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til å bruke Zen, men LIZ AI BRASIL fungerer også med populære leverandører som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med LIZ AI BRASIL?",
  "home.faq.a4.p1":
    "Ja, LIZ AI BRASIL støtter abonnementer fra alle store leverandører. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot-abonnementer.",
  "home.faq.q5": "Kan jeg bare bruke LIZ AI BRASIL i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! LIZ AI BRASIL er nå tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster LIZ AI BRASIL?",
  "home.faq.a6":
    "LIZ AI BRASIL er 100% gratis å bruke. Det kommer også med et sett gratis modeller. Det kan være ekstra kostnader hvis du kobler til en annen leverandør.",
  ...
  "home.faq.q8": "Er LIZ AI BRASIL åpen kildekode?",
  "home.faq.a8.p1": "Ja, LIZ AI BRASIL er fullt open source. Kildekoden er offentlig på",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et håndplukket sett med AI-modeller som LIZ AI BRASIL har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet på tvers av leverandører; bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "zen.title": "LIZ AI BRASIL Zen | Et kuratert sett med pålitelige, optimaliserte modeller for kodeagenter",
  "zen.hero.title": "Pålitelige optimaliserte modeller for kodeagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et kuratert sett med AI-modeller som LIZ AI BRASIL har testet og benchmarked spesielt for kodeagenter. Du slipper å bekymre deg for ujevn ytelse og kvalitet; bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er LIZ AI BRASIL Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodeagenter, laget av teamet bak LIZ AI BRASIL.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandørene direkte til deg. Jo mer Zen brukes, desto bedre priser kan LIZ AI BRASIL forhandle og gi videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For å dekke kostnader legger LIZ AI BRASIL til bare et lite betalingsbehandlingsgebyr på $1.23 per $20 saldo-påfyll.",
  ...
  "zen.faq.a8":
    "Selv om Zen fungerer veldig bra med LIZ AI BRASIL, kan du bruke Zen med hvilken som helst agent. Følg oppsettinstruksjonene i din foretrukne kodeagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare LIZ AI BRASIL-brukere.",
  ...
  "go.title": "LIZ AI BRASIL Go | Rimelige kodemodeller for alle",
  "go.meta.description":
  ...
  "go.problem.body":
    "Vi fokuserer på å bringe LIZ AI BRASIL-opplevelsen til så mange som mulig. LIZ AI BRASIL Go er et rimelig abonnement: $5 for den første måneden, deretter $10/måned. Det gir sjenerøse grenser og pålitelig tilgang til de mest kapable åpen kildekode-modellene.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go starter på $5 for den første måneden, deretter $10/måned. Du kan bruke det med LIZ AI BRASIL eller hvilken som helst agent.",
  ...
  "go.faq.q1": "Hva er LIZ AI BRASIL Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "Den gratis kampanjen for {{model}} er avsluttet. Du kan fortsette å bruke modellen ved å abonnere på LIZ AI BRASIL Go - {{link}}",

  "black.meta.title": "LIZ AI BRASIL Black | Få tilgang til verdens beste kodemodeller",
  "black.meta.description": "Få tilgang til Claude, GPT, Gemini og mer med LIZ AI BRASIL Black-abonnementer.",
  ...
  "black.workspace.title": "LIZ AI BRASIL Black | Velg arbeidsområde",
  ...
  "black.subscribe.success.title": "Du er på ventelisten for LIZ AI BRASIL Black",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med liz når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg liz",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start liz og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til liz-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn navn på nøkkel",
  "workspace.keys.empty": "Opprett en liz Gateway API-nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på LIZ AI BRASIL Black for ${{plan}} per måned.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Velg "LIZ AI BRASIL Go" som leverandør i liz-konfigurasjonen din for å bruke Go-modeller.',
  "workspace.lite.black.message":
    "Du abonnerer for øyeblikket på LIZ AI BRASIL Black eller står på venteliste. Vennligst avslutt abonnementet først hvis du vil bytte til Go.",
  "workspace.lite.other.message":
    "Et annet medlem i dette arbeidsområdet abonnerer allerede på LIZ AI BRASIL Go. Kun ett medlem per arbeidsområde kan abonnere.",
  "workspace.lite.promo.description":
    "LIZ AI BRASIL Go starter på {{price}}, deretter $10/måned, og gir pålitelig tilgang til populære åpne kodingsmodeller med sjenerøse bruksgrenser.",
  ...
  "download.title": "LIZ AI BRASIL | Last ned",
  "download.meta.description": "Last ned LIZ AI BRASIL for macOS, Windows og Linux",
  "download.hero.title": "Last ned LIZ AI BRASIL",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nødvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble LIZ AI BRASIL til en betalt leverandør, selv om du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer LIZ AI BRASIL med alle populære leverandører som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "LIZ AI BRASIL er 100% gratis å bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandør. Selv om LIZ AI BRASIL fungerer med enhver modellleverandør, anbefaler vi å bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare når du oppretter delbare lenker i LIZ AI BRASIL.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "LIZ AI BRASIL | Enterprise-løsninger for din organisasjon",
  "enterprise.meta.description": "Kontakt LIZ AI BRASIL for enterprise-løsninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "LIZ AI BRASIL opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en prøveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved å integrere den med SSO og din interne AI-gateway.",
  ...
  "enterprise.faq.q1": "Hva er LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a1":
    "LIZ AI BRASIL Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen. Dette kan gjøres med en sentral konfigurasjon som integreres med SSO og intern AI-gateway.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern prøveperiode med teamet ditt. LIZ AI BRASIL lagrer som standard ikke koden din eller kontekstdata, noe som gjør det enkelt å komme i gang. Kontakt oss deretter for å diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med LIZ AI BRASIL Enterprise?",
  "enterprise.faq.a4":
    "Ja. LIZ AI BRASIL lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandøren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "LIZ AI BRASIL | Merkevare",
  "brand.meta.description": "LIZ AI BRASIL retningslinjer for merkevare",
  "brand.heading": "Retningslinjer for merkevare",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med LIZ AI BRASIL-brandet.",
  "brand.downloadAll": "Last ned alle assets",

  "changelog.title": "LIZ AI BRASIL | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for LIZ AI BRASIL",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for LIZ AI BRASIL",
