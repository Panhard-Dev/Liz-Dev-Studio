...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | liz",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "liz açık logo",
  "notFound.logoDarkAlt": "liz koyu logo",
  ...
  "app.meta.description": "LIZ AI BRASIL - Açık kaynaklı kodlama ajanı.",

  "home.title": "LIZ AI BRASIL | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "liz | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "liz tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "liz TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı liz TUI",
  "temp.logoLightAlt": "liz açık logo",
  "temp.logoDarkAlt": "liz koyu logo",
  ...
  "home.what.title": "LIZ AI BRASIL nedir?",
  "home.what.body":
    "LIZ AI BRASIL, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile LIZ AI BRASIL, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "LIZ AI BRASIL kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "LIZ AI BRASIL nedir?",
  "home.faq.a1":
    "LIZ AI BRASIL, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "LIZ AI BRASIL'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "LIZ AI BRASIL için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. LIZ AI BRASIL, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak LIZ AI BRASIL OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi bağlayabilirsiniz",
  "home.faq.q4": "Mevcut AI aboneliklerimi LIZ AI BRASIL ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. LIZ AI BRASIL tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "LIZ AI BRASIL'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! LIZ AI BRASIL artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "LIZ AI BRASIL ne kadar?",
  "home.faq.a6":
    "LIZ AI BRASIL %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "LIZ AI BRASIL açık kaynak mı?",
  "home.faq.a8.p1": "Evet, LIZ AI BRASIL tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "home.zenCta.body":
    "Zen, LIZ AI BRASIL'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "LIZ AI BRASIL Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, LIZ AI BRASIL'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "LIZ AI BRASIL Zen nedir?",
  "zen.faq.a1":
    "Zen, LIZ AI BRASIL ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça LIZ AI BRASIL daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için LIZ AI BRASIL, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen LIZ AI BRASIL ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca LIZ AI BRASIL kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i LIZ AI BRASIL ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "go.title": "LIZ AI BRASIL Go | Herkes için düşük maliyetli kodlama modelleri",
  "go.meta.description":
  ...
  "go.graph.freePill": "LIZ Pixel ve ücretsiz modeller",
  "go.graph.go": "Go",
  ...
  "go.problem.body":
    "LIZ AI BRASIL deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. LIZ AI BRASIL Go düşük maliyetli bir aboneliktir: İlk ay $5, sonrasında ayda 10$. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "Go ilk ay $5, sonrasında ayda 10$ fiyatıyla başlar. LIZ AI BRASIL veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "go.faq.q1": "LIZ AI BRASIL Go nedir?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "{{model}} için ücretsiz promosyon sona erdi. LIZ AI BRASIL Go'ya abone olarak modeli kullanmaya devam edebilirsiniz - {{link}}",

  "black.meta.title": "LIZ AI BRASIL Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "LIZ AI BRASIL Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "LIZ AI BRASIL Black | Fiyatlandırma",
  ...
  "black.workspace.title": "LIZ AI BRASIL Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "LIZ AI BRASIL Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "LIZ AI BRASIL Black bekleme listesindesiniz",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman liz ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve liz seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "liz'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "liz hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir liz Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında LIZ AI BRASIL Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} LIZ AI BRASIL Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki LIZ AI BRASIL Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.subscription.message": "LIZ AI BRASIL Go abonesisiniz.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için liz yapılandırmanızda "LIZ AI BRASIL Go"\'yu sağlayıcı olarak seçin.',
  "workspace.lite.black.message":
    "Şu anda LIZ AI BRASIL Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
  "workspace.lite.other.message":
    "Bu çalışma alanındaki başka bir üye zaten LIZ AI BRASIL Go abonesi. Çalışma alanı başına yalnızca bir üye abone olabilir.",
  "workspace.lite.promo.description":
    "LIZ AI BRASIL Go {{price}} fiyatından başlar, sonrasında ayda 10$ olur ve cömert kullanım limitleriyle popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.title": "LIZ AI BRASIL | İndir",
  "download.meta.description": "LIZ AI BRASIL'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "LIZ AI BRASIL'u İndir",
  ...
  "download.section.extensions": "LIZ AI BRASIL Eklentileri",
  "download.section.integrations": "LIZ AI BRASIL Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. LIZ AI BRASIL'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak LIZ AI BRASIL OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "LIZ AI BRASIL %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. LIZ AI BRASIL herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca LIZ AI BRASIL'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "LIZ AI BRASIL | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için LIZ AI BRASIL ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "LIZ AI BRASIL, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "LIZ AI BRASIL Enterprise nedir?",
  "enterprise.faq.a1":
    "LIZ AI BRASIL Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "LIZ AI BRASIL Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. LIZ AI BRASIL varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "LIZ AI BRASIL Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. LIZ AI BRASIL kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "LIZ AI BRASIL | Marka",
  "brand.meta.description": "LIZ AI BRASIL marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "LIZ AI BRASIL markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "LIZ AI BRASIL | Değişiklik günlüğü",
  "changelog.meta.description": "LIZ AI BRASIL sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "LIZ AI BRASIL için yeni güncellemeler ve iyileştirmeler",
