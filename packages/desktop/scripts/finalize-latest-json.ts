...
const releaseId = process.env.LIZ_RELEASE
if (!releaseId) throw new Error("LIZ_RELEASE is required")

const version = process.env.LIZ_VERSION
if (!version) throw new Error("LIZ_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "liz-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "liz-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "liz-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "liz-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "liz-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "liz-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "liz-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "liz-desktop-darwin-aarch64.app.tar.gz",
  },
]
