export const dict = {
  ...
  "desktop.menu.help.documentation": "وثائق LIZ AI BRASIL",
  ...
  "desktop.cli.error.sidecarMissing": "ملف LIZ AI BRASIL CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
