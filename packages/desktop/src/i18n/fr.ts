export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentation d'LIZ AI BRASIL",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI LIZ AI BRASIL est manquant. Essayez de réinstaller l'application de bureau.",
