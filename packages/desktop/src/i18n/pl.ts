export const dict = {
  ...
  "desktop.menu.help.documentation": "Dokumentacja LIZ AI BRASIL",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego LIZ AI BRASIL CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
