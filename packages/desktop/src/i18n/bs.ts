export const dict = {
  ...
  "desktop.menu.help.documentation": "LIZ AI BRASIL Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka LIZ AI BRASIL CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
