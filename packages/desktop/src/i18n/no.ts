export const dict = {
  ...
  "desktop.menu.app": "LIZ AI BRASIL",
  ...
  "desktop.menu.help.documentation": "LIZ AI BRASIL Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "LIZ AI BRASIL CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
