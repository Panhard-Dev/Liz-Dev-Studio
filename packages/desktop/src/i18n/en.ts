export const dict = {
  ...
  "desktop.menu.help.documentation": "LIZ AI BRASIL Documentation",
  ...
  "desktop.cli.error.sidecarMissing": "LIZ AI BRASIL CLI binary is missing. Try reinstalling the desktop app.",
