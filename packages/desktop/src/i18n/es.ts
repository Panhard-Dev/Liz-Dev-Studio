export const dict = {
  ...
  "desktop.menu.help.documentation": "Documentación de LIZ AI BRASIL",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de LIZ AI BRASIL. Intenta reinstalar la aplicación de escritorio.",
