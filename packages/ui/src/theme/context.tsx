...
const STORAGE_KEYS = {
  THEME_ID: "liz-theme-id",
  COLOR_SCHEME: "liz-color-scheme",
  THEME_CSS_LIGHT: "liz-theme-css-light",
  THEME_CSS_DARK: "liz-theme-css-dark",
} as const

const THEME_STYLE_ID = "liz-theme"
...
function applyThemeCss(theme: DesktopTheme, themeId: string, mode: "light" | "dark") {
  ...
  document.getElementById("liz-theme-preload")?.remove()
