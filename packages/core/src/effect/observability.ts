...
import { ensureProcessMetadata } from "../util/liz-process"
...
export function resource(): { serviceName: string; serviceVersion: string; attributes: Record<string, string> } {
  ...
  return {
    ...
    attributes: {
      ...
      "liz.client": Flag.LIZ_CLIENT,
      "liz.process_role": processMetadata.processRole,
      "liz.run_id": processMetadata.runID,
