export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من LIZ AI BRASIL",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من LIZ AI BRASIL، هل ترغب في تثبيته وإعادة تشغيله؟",
