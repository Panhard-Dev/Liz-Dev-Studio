export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do LIZ AI BRASIL",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do LIZ AI BRASIL foi baixada. Você gostaria de instalá-la e reiniciar?",
