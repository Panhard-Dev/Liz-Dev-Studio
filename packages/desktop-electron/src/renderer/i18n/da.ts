export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af LIZ AI BRASIL",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af LIZ AI BRASIL er blevet downloadet. Vil du installere den og genstarte?",
