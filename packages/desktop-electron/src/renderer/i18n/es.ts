export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de LIZ AI BRASIL",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de LIZ AI BRASIL. ¿Quieres instalarla y reiniciar?",
