export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju LIZ AI BRASIL-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} LIZ AI BRASIL-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
