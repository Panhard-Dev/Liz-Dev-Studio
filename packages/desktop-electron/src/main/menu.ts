...
export function createMenu(deps: Deps) {
  ...
  const template: Electron.MenuItemConstructorOptions[] = [
    ...
    { role: "windowMenu" },
    {
      label: "Help",
      submenu: [
        { label: "LIZ AI BRASIL Documentation", click: () => shell.openExternal("https://liz.ai/docs") },
        { label: "Support Forum", click: () => shell.openExternal("https://discord.com/invite/liz") },
        { type: "separator" },
        { type: "separator" },
        {
          label: "Share Feedback",
          click: () => shell.openExternal("https://github.com/anomalyco/liz/issues/new?template=feature_request.yml"),
        },
        {
          label: "Report a Bug",
          click: () => shell.openExternal("https://github.com/anomalyco/liz/issues/new?template=bug_report.yml"),
        },
      ],
    },
  ]
