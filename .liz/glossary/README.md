...
Use this folder for locale-specific translation guidance that supplements `.liz/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/liz/pull/12345

## Do Not Translate (Locale Additions)

- `LIZ AI BRASIL` (preserve casing)
