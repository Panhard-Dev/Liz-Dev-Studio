...
- PR #13942: https://github.com/Panhard-Dev/Liz-Dev-Studio/pull/13942

## Do Not Translate (Locale Additions)

- `LIZ AI BRASIL` (preserve casing in prose; keep `liz` only when it is part of commands, package names, paths, or code)
- `LIZ AI BRASIL Zen`
- `LIZ AI BRASIL CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `liz` in prose when referring to the product name; use `LIZ AI BRASIL`
