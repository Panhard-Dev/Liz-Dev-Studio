...
- PR #15835: https://github.com/Panhard-Dev/Liz-Dev-Studio/pull/15835

## Do Not Translate (Locale Additions)

- `LIZ AI BRASIL` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `liz` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `LIZ AI BRASIL` in prose, `liz` only for exact technical identifiers
...
- Avoid changing `liz` to `LIZ AI BRASIL` inside commands, URLs, package names, or code literals
