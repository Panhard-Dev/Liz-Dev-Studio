...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/anomalyco/liz/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for anomalyco/liz...\n")
...
console.log("Fetching npm all-time downloads for liz-ai-brasil...\n")
const npmDownloads = await fetchNpmDownloads("liz-ai-brasil")
