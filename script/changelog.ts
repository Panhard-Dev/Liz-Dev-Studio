...
Generates UPCOMING_CHANGELOG.md by running the liz changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for liz run (default: low)
      --quiet            Suppress liz command output unless it fails
